...
function Aboutme() {
  ...
  return (
    <div className="flex flex-col">
      <div className="flex flex-col justify-center pt-72 pb-16 px-72 text-left gap-16 sm:pt-40 sm:px-8">
        ...
        <div className="columns-2 gap-16 text-lg text-body sm:columns-1">
          {FormattingTranslation('ABOUTME.DESCRIPTION')}
        </div>
      </div>
      <div className="w-screen bg-light-gray flex flex-row py-16 px-72 gap-11 sm:flex-col sm:px-8">
        <div className="flex-2 font-bold text-3xl">
          {t('ABOUTME.SKILLS.TITLE')}
          <div className="border-b-2 border-body"></div>
          <div className="columns-2 font-normal text-body pt-6 sm:columns-1">
